...
class Application:
    def __init__(self, master=None):
        ...
        self.btnAtualizar["command"] = self.buscarUsuario
    ...
    def buscarUsuario(self):
        ...
        self.txtidusuario.delete(0, END)
        self.txtidusuario.insert(INSERT, 'jubileu zum zum')

        self.txtnome.delete(0, END)
        self.txtnome.insert(INSERT, 'jubileu zum zum')

        self.txttelefone.delete(0, END)
        self.txttelefone.insert(INSERT,'jubileu zum zum')

        self.txtemail.delete(0, END)
        self.txtemail.insert(INSERT, 'jubileu zum zum')

        self.txtusuario.delete(0, END)
        self.txtusuario.insert(INSERT, 'jubileu zum zum')

        self.txtsenha.delete(0, END)
        self.txtsenha.insert(INSERT,'jubileu zum zum')
